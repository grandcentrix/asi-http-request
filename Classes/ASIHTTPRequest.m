...
+ (void)registerForNetworkReachabilityNotifications
{
	[[CFReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[CFReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);
}
